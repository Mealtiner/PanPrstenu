  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Kde se akce koná?', a: `Akce se koná v lokalitě <strong>Pulkovský mlýn u obce Rozkoš</strong> (pomezí Znojemska a Třebíčska). V roce 2025 proběhl přesun na větší louku v blízkosti dřívějšího tábořiště. GPS: <code>49.0388528, 15.9743275</code>. Dočasná mapa a další informace na stránce <a href="${L('/mapa/')}" class="underline">Mapa areálu</a> a v <a href="${L('/organizacni-informace/')}" class="underline">Organizačních informacích</a>.` },
  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Where is it held?', a: `The event takes place at <strong>Pulkovský mlýn, near the village of Rozkoš</strong> (Znojmo / Třebíč borderlands). In 2025 we moved to a larger meadow near the previous campsite. GPS: <code>49.0388528, 15.9743275</code>. Temporary map and more info at <a href="${L('/mapa/')}" class="underline">Site map</a> and in the <a href="${L('/organizacni-informace/')}" class="underline">Organisational information</a>.` },
  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Wo findet sie statt?', a: `Die Veranstaltung findet beim <strong>Pulkovský mlýn, beim Dorf Rozkoš</strong> (Grenzregion Znaim / Třebíč) statt. 2025 sind wir auf eine größere Wiese in der Nähe des bisherigen Lagerplatzes umgezogen. GPS: <code>49.0388528, 15.9743275</code>. Vorläufige Karte und weitere Infos auf <a href="${L('/mapa/')}" class="underline">Lageplan</a> sowie in <a href="${L('/organizacni-informace/')}" class="underline">Organisatorischen Informationen</a>.` },
  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Kde sa akcia koná?', a: `Akcia sa koná v lokalite <strong>Pulkovský mlýn pri obci Rozkoš</strong> (pomedzie Znojemska a Třebíčska). V roku 2025 sme sa presťahovali na väčšiu lúku v blízkosti pôvodného tábora. GPS: <code>49.0388528, 15.9743275</code>. Dočasná mapa a ďalšie informácie na stránke <a href="${L('/mapa/')}" class="underline">Mapa areálu</a> a v <a href="${L('/organizacni-informace/')}" class="underline">Organizačných informáciách</a>.` },
  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Де проходить захід?', a: `Захід проходить біля <strong>Пулковського млина, поблизу села Розкош</strong> (межа Зноємщини та Тршебічщини). У 2025 році подію перенесено на більшу галявину поблизу попереднього табору. GPS: <code>49.0388528, 15.9743275</code>. Тимчасова карта та інша інформація на сторінці <a href="${L('/mapa/')}" class="underline">Карта території</a> та в <a href="${L('/organizacni-informace/')}" class="underline">Організаційній інформації</a>.` },
