  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Kde najdu výši registračního poplatku?', a: `Přehled registračních poplatků, termínů a případných doplatků je na stránce <a href="${L('/registrace/')}" class="underline">Registrace</a>. Aktuální informace najdeš také v <a href="${L('/prakticke-info/')}" class="underline">Praktických informacích</a>.` },
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Máte půjčovnu kostýmů?', a: `Můžeme mít omezené množství základních věcí k zapůjčení, ale nespoléhej na to automaticky. Domluv se předem. Kostým je primárně odpovědnost účastníka.` },
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Jsou na místě sprchy a elektřina?', a: `S komfortem počítej spíše jako na táboře. Nečekej hotel, zásuvku u stanu ani koupelnu za rohem. Aktuální informace o zázemí budou v <a href="${L('/prakticke-info/')}" class="underline">Praktických informacích</a>.` },
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Dá se přijet veřejnou dopravou?', a: `Možnosti veřejné dopravy budou popsané v <a href="${L('/prakticke-info/')}" class="underline">Praktických informacích</a> nebo v pokynech před akcí. Počítej s tím, že část cesty může být potřeba dojít pěšky.` },
      ],
    },
    {
      id: 'detska-hra',
  ...
  return [
    {
      ...
      items: [
        ...
        { q: 'Is the event suitable for newcomers?', a: `Yes. Newcomers are welcome. You do not need any prior larp experience. The important thing is to read the basics, choose an army, prepare a costume and not be afraid to ask. Recommended path: <a href="${L('/pro-novacky/')}" class="underline">First time here</a> → <a href="${L('/frakce/')}" class="underline">Armies</a> → <a href="${L('/pravidla/')}" class="underline">Rules</a> → <a href="${L('/prakticke-info/')}" class="underline">Practical info</a> → <a href="${L('/registrace/')}" class="underline">Registration</a>.`, faqSnippet: true },
    ...
    },
    {
      ...
      icon: 'lucide:calendar-days',
      items: [
        { q: 'When is the event?', a: `The 2026 edition runs from <strong>20 to 23 August 2026</strong>. Thursday: arrival, camp, registration, first meet-ups. Friday: side programme, camp game, children’s game, market, arenas, preparation. Saturday: main game / battle. Sunday: packing, clean-up, departure. Up-to-date info at <a href="${L('/prakticke-info/')}" class="underline">Practical info</a>.` },
        { q: 'Where is it held?', a: `The event takes place in the south of Moravia, in the Křtiny / Bukovina area. Detailed arrival instructions and venue info are at <a href="${L('/prakticke-info/')}" class="underline">Practical info</a> and in e-mails for registered participants. Map at <a href="${L('/mapa/')}" class="underline">Site map</a>.` },
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Where can I find the registration fee?', a: `An overview of fees, deadlines and possible surcharges is on <a href="${L('/registrace/')}" class="underline">Registration</a>. Up-to-date info also at <a href="${L('/prakticke-info/')}" class="underline">Practical info</a>.` },
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Are there showers and electricity on site?', a: `Plan for camp-level comfort. Don’t expect a hotel, an outlet next to your tent or a bathroom around the corner. Up-to-date facility info will be on <a href="${L('/prakticke-info/')}" class="underline">Practical info</a>.` },
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Can I get there by public transport?', a: `Public transport options will be described on <a href="${L('/prakticke-info/')}" class="underline">Practical info</a> or in pre-event briefings. Expect that part of the journey may need to be walked.` },
      ],
    },
    {
      id: 'detska-hra',
  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Wo finde ich die Höhe der Anmeldegebühr?', a: `Eine Übersicht der Gebühren, Fristen und etwaiger Aufschläge findest du auf <a href="${L('/registrace/')}" class="underline">Anmeldung</a>. Aktuelles auch auf <a href="${L('/prakticke-info/')}" class="underline">Praktische Infos</a>.` },
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Gibt es Duschen und Strom vor Ort?', a: `Plane mit Lager-Komfort. Erwarte kein Hotel, keine Steckdose am Zelt und kein Bad um die Ecke. Aktuelles zur Infrastruktur kommt auf <a href="${L('/prakticke-info/')}" class="underline">Praktische Infos</a>.` },
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Komme ich mit dem ÖPNV hin?', a: `ÖPNV-Optionen werden auf <a href="${L('/prakticke-info/')}" class="underline">Praktische Infos</a> oder in den Pre-Event-Briefings beschrieben. Rechne damit, dass ein Teil zu Fuß zu bewältigen ist.` },
      ],
    },
    {
      id: 'detska-hra',
...
function sk(L: LinkFn): FaqGroup[] {
  return [
    ...
    },
    {
      ...
      icon: 'lucide:calendar-days',
      items: [
        { q: 'Kedy sa akcia koná?', a: `Ročník 2026 sa koná od <strong>20. do 23. 8. 2026</strong>. Štvrtok: príchod, tábor, registrácia, prvé stretnutia. Piatok: doprovodný program, hra v tábore, detská hra, jarmok, arény, príprava. Sobota: hlavná hra / bitka. Nedeľa: balenie, upratovanie, odchod. Aktuálne informácie na <a href="${L('/prakticke-info/')}" class="underline">Praktických informáciách</a>.` },
        { q: 'Kde sa akcia koná?', a: `Akcia sa koná v oblasti južnej Moravy, v lokalite Křtiny / Bukovina. Presné pokyny k príchodu a informácie k miestu sleduj na <a href="${L('/prakticke-info/')}" class="underline">Praktických informáciách</a> a v e-mailoch pre registrovaných účastníkov. Mapa na stránke <a href="${L('/mapa/')}" class="underline">Mapa areálu</a>.` },
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Kde nájdem výšku registračného poplatku?', a: `Prehľad registračných poplatkov, termínov a prípadných doplatkov je na stránke <a href="${L('/registrace/')}" class="underline">Registrácia</a>. Aktuálne informácie aj na <a href="${L('/prakticke-info/')}" class="underline">Praktických informáciách</a>.` },
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Sú na mieste sprchy a elektrina?', a: `S komfortom rátaj skôr ako na tábore. Nečakaj hotel, zásuvku pri stane ani kúpeľňu za rohom. Aktuálne informácie o zázemí budú na <a href="${L('/prakticke-info/')}" class="underline">Praktických informáciách</a>.` },
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Dá sa prísť verejnou dopravou?', a: `Možnosti verejnej dopravy budú popísané na <a href="${L('/prakticke-info/')}" class="underline">Praktických informáciách</a> alebo v pokynoch pred akciou. Rátaj s tým, že časť cesty môže byť potrebné prejsť pešo.` },
      ],
    },
    {
      id: 'detska-hra',
  ...
  return [
    {
      ...
      items: [
        ...
        { q: 'Чи захід підходить новачкам?', a: `Так. Новачки бажані. Ти не мусиш мати жодного попереднього ларп-досвіду. Важливо прочитати основну інформацію, обрати армію, підготувати костюм і не боятися запитати. Рекомендований шлях: <a href="${L('/pro-novacky/')}" class="underline">Для новачків</a> → <a href="${L('/frakce/')}" class="underline">Армії</a> → <a href="${L('/pravidla/')}" class="underline">Правила</a> → <a href="${L('/prakticke-info/')}" class="underline">Практична інформація</a> → <a href="${L('/registrace/')}" class="underline">Реєстрація</a>.`, faqSnippet: true },
    ...
    },
    {
      ...
      icon: 'lucide:calendar-days',
      items: [
        { q: 'Коли проходить захід?', a: `Випуск 2026 проходить з <strong>20 до 23 серпня 2026</strong>. Четвер: приїзд, табір, реєстрація, перші зустрічі. П\'ятниця: супровідна програма, гра в таборі, дитяча гра, ярмарок, арени, підготовка. Субота: головна гра / битва. Неділя: збори, прибирання, від\'їзд. Актуальна інформація на <a href="${L('/prakticke-info/')}" class="underline">Практична інформація</a>.` },
        { q: 'Де проходить захід?', a: `Захід проходить на півдні Моравії, в районі Křtiny / Bukovina. Точні інструкції щодо приїзду та інформація про місце на <a href="${L('/prakticke-info/')}" class="underline">Практичній інформації</a> та в електронних листах для зареєстрованих учасників. Карта на сторінці <a href="${L('/mapa/')}" class="underline">Карта території</a>.` },
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Де знайти суму реєстраційного внеску?', a: `Огляд внесків, термінів та можливих доплат на сторінці <a href="${L('/registrace/')}" class="underline">Реєстрація</a>. Актуальна інформація також на <a href="${L('/prakticke-info/')}" class="underline">Практичній інформації</a>.` },
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Чи є на місці душові й електрика?', a: `Розраховуй на табірний рівень комфорту. Не очікуй готелю, розетки біля намету чи ванної за рогом. Актуальна інформація про інфраструктуру буде на <a href="${L('/prakticke-info/')}" class="underline">Практичній інформації</a>.` },
    ...
    },
    {
      ...
      items: [
        ...
        { q: 'Чи можна дістатися громадським транспортом?', a: `Опції громадського транспорту опишемо на <a href="${L('/prakticke-info/')}" class="underline">Практичній інформації</a> або в брифінгах перед заходом. Зважай, що частину шляху, можливо, доведеться пройти пішки.` },
      ],
    },
    {
      id: 'detska-hra',
