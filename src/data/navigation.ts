  ...
  },
  {
    ...
    columns: [
      ...
      },
      {
        ...
        items: [
          { label: 'Návody pro nováčky', href: '/navody-a-inspirace/#novacky', description: 'Kostým, výbava, první LARP a hodnocení 2–4 životů.', i18n: { en: { label: 'Guides for newcomers', description: 'Costume, gear, first LARP and 2–4 lives scoring.' }, de: { label: 'Anleitungen für Einsteiger', description: 'Kostüm, Ausrüstung, erstes LARP und 2–4 Leben Bewertung.' }, sk: { label: 'Návody pre nováčikov', description: 'Kostým, výbava, prvý LARP a hodnotenie 2–4 životov.' }, uk: { label: 'Інструкції для новачків', description: 'Костюм, спорядження, перший LARP і оцінка 2–4 життів.' } } },
          { label: 'Kostýmová inspirace', href: '/navody-a-inspirace/#kostymy', description: 'Inspiromat 9 armád + návody na výrobu kostýmu.', i18n: { en: { label: 'Costume inspiration', description: 'Inspiromat for 9 armies + costume crafting guides.' }, de: { label: 'Kostüminspiration', description: 'Inspiromat für 9 Armeen + Anleitungen zur Kostümherstellung.' }, sk: { label: 'Kostýmová inšpirácia', description: 'Inspiromat 9 armád + návody na výrobu kostýmu.' }, uk: { label: 'Натхнення для костюма', description: 'Інспіромат 9 армій + інструкції з виготовлення костюма.' } } },
          { label: 'Výroba zbraní a vybavení', href: '/navody-a-inspirace/#vyroba', description: 'Návody na meče, sekery, štíty, čutory a brašny.', i18n: { en: { label: 'Weapon and gear crafting', description: 'Guides for swords, axes, shields, flasks and bags.' }, de: { label: 'Waffen- und Ausrüstungsbau', description: 'Anleitungen für Schwerter, Äxte, Schilde, Feldflaschen und Taschen.' }, sk: { label: 'Výroba zbraní a výbavy', description: 'Návody na meče, sekery, štíty, čutory a brašne.' }, uk: { label: 'Виготовлення зброї і спорядження', description: 'Інструкції для мечів, сокир, щитів, фляг і сумок.' } } },
          { label: 'Užitečné odkazy', href: '/navody-a-inspirace/#odkazy', description: 'LARP.cz, hurka.uhobitu.cz a B5A archiv.', i18n: { en: { label: 'Useful links', description: 'LARP.cz, hurka.uhobitu.cz and B5A archive.' }, de: { label: 'Nützliche Links', description: 'LARP.cz, hurka.uhobitu.cz und B5A-Archiv.' }, sk: { label: 'Užitočné odkazy', description: 'LARP.cz, hurka.uhobitu.cz a B5A archív.' }, uk: { label: 'Корисні посилання', description: 'LARP.cz, hurka.uhobitu.cz і архів B5A.' } } },
        ],
      },
      {
