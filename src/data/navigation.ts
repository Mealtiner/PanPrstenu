...
export const mainNavigation: NavItem[] = [
    ...
    columns: [
      {
        ...
        items: [
          ...
          { label: 'Žoldáci', href: '/frakce/#zoldaci', description: 'Horalé z Vrchoviny — neutrální vyrovnávací strana.', i18n: { en: { label: 'Mercenaries', description: 'Highlanders of Vrchovina — neutral balancing side.' }, de: { label: 'Söldner', description: 'Hochländer aus Vrchovina — neutrale Ausgleichsseite.' }, sk: { label: 'Žoldnieri', description: 'Horali z Vrchoviny — neutrálna vyrovnávacia strana.' }, uk: { label: 'Найманці', description: 'Горяни з Верховини — нейтральна врівноважувальна сторона.' } } },
        ],
      },
      {
  ...
  },
  {
    ...
    columns: [
      {
        ...
        items: [
          { label: 'Praktické informace', href: '/prakticke-info/', description: 'Termín, místo, program, příjezd, tábořiště a služby na místě.', i18n: { en: { label: 'Practical info', description: 'Date, place, schedule, arrival, camp and on-site services.' }, de: { label: 'Praktische Infos', description: 'Termin, Ort, Programm, Anreise, Lager und Vor-Ort-Services.' }, sk: { label: 'Praktické info', description: 'Termín, miesto, program, príchod, tábor a služby na mieste.' }, uk: { label: 'Практична інформація', description: 'Дата, місце, розклад, приїзд, табір і послуги на місці.' } } },
          { label: 'Organizační informace', href: '/organizacni-informace/', description: 'Dokumenty, parkování, role účastníků a další provozní věci.', i18n: { en: { label: 'Organisation', description: 'Documents, parking, participant roles and operational matters.' }, de: { label: 'Organisatorisches', description: 'Dokumente, Parken, Teilnehmerrollen und Betriebsthemen.' }, sk: { label: 'Organizačné info', description: 'Dokumenty, parkovanie, úlohy účastníkov a prevádzkové veci.' }, uk: { label: 'Організаційна інформація', description: 'Документи, парковка, ролі учасників і провадження.' } } },
          { label: 'Harmonogram', href: '/prakticke-info/#harmonogram', description: 'Čtvrtek příjezd, pátek program, sobota bitva, neděle odjezd.', i18n: { en: { label: 'Schedule', description: 'Thursday arrival, Friday programme, Saturday battle, Sunday departure.' }, de: { label: 'Programm', description: 'Donnerstag Anreise, Freitag Programm, Samstag Schlacht, Sonntag Abreise.' }, sk: { label: 'Harmonogram', description: 'Štvrtok príchod, piatok program, sobota bitka, nedeľa odchod.' }, uk: { label: 'Розклад', description: 'Четвер приїзд, п’ятниця програма, субота битва, неділя від’їзд.' } } },
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Bezpečnost dětí', href: '/bezpecnost/', description: 'Jak řešíme bezpečí mladších účastníků.', i18n: { en: { label: 'Children safety', description: 'How we handle the safety of younger participants.' }, de: { label: 'Sicherheit der Kinder', description: 'Wie wir die Sicherheit jüngerer Teilnehmer regeln.' }, sk: { label: 'Bezpečnosť detí', description: 'Ako riešime bezpečnosť mladších účastníkov.' }, uk: { label: 'Безпека дітей', description: 'Як забезпечуємо безпеку молодших учасників.' } } },
          { label: 'Účast mladších 18 let', href: '/organizacni-informace/', description: 'Souhlas zákonného zástupce a potřebné dokumenty.', i18n: { en: { label: 'Under-18 participation', description: 'Legal guardian consent and required documents.' }, de: { label: 'Teilnahme unter 18', description: 'Einwilligung der Erziehungsberechtigten und Dokumente.' }, sk: { label: 'Účasť mladších 18 rokov', description: 'Súhlas zákonného zástupcu a potrebné dokumenty.' }, uk: { label: 'Участь до 18 років', description: 'Згода законного представника та потрібні документи.' } } },
        ],
      },
      {
        ...
        items: [
          ...
          { label: 'Bezpečnost a krizové situace', href: '/bezpecnost/', description: 'Tísňové kontakty, zranění, počasí a krizové postupy.', i18n: { en: { label: 'Safety and emergencies', description: 'Emergency contacts, injuries, weather and crisis procedures.' }, de: { label: 'Sicherheit und Notfälle', description: 'Notrufe, Verletzungen, Wetter und Krisenabläufe.' }, sk: { label: 'Bezpečnosť a krízové situácie', description: 'Tiesňové kontakty, zranenia, počasie a krízové postupy.' }, uk: { label: 'Безпека та надзвичайні ситуації', description: 'Контакти екстрених служб, травми, погода і кризові процедури.' } } },
          { label: 'Stravování', href: '/prakticke-info/#stravovani', description: 'Jídlo, pitná voda a hospoda U Zeleného draka.', i18n: { en: { label: 'Food and drink', description: 'Meals, drinking water and the U Zeleného draka inn.' }, de: { label: 'Verpflegung', description: 'Essen, Trinkwasser und das Wirtshaus U Zeleného draka.' }, sk: { label: 'Stravovanie', description: 'Jedlo, pitná voda a hostinec U Zeleného draka.' }, uk: { label: 'Харчування', description: 'Їжа, питна вода і корчма «У Zeleného draka».' } } },
          { label: 'Co si vzít s sebou', href: '/pro-novacky/#co-vzit', description: 'Základní výbava pro první účast.', i18n: { en: { label: 'What to bring', description: 'Basic gear list for first-time participants.' }, de: { label: 'Was mitnehmen', description: 'Grundausrüstung für die erste Teilnahme.' }, sk: { label: 'Čo si vziať so sebou', description: 'Základná výbava pre prvú účasť.' }, uk: { label: 'Що з собою', description: 'Базове спорядження для першої участі.' } } },
    ...
    highlight: {
      ...
      links: [
        { label: 'Harmonogram', href: '/prakticke-info/#harmonogram', i18n: { en: { label: 'Schedule', description: 'Thursday arrival, Friday programme, Saturday battle, Sunday departure.' }, de: { label: 'Programm', description: 'Donnerstag Anreise, Freitag Programm, Samstag Schlacht, Sonntag Abreise.' }, sk: { label: 'Harmonogram', description: 'Štvrtok príchod, piatok program, sobota bitka, nedeľa odchod.' }, uk: { label: 'Розклад', description: 'Четвер приїзд, п’ятниця програма, субота битва, неділя від’їзд.' } } },
