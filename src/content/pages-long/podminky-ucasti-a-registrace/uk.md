...
> **Не хочеш читати всі умови?** Найважливіші практичні речі знайдеш на сторінках [Реєстрація](/uk/registrace/), [Практична інформація](/uk/organizacni-informace/) та [Правила і безпека](/uk/pravidla/).
...
Якщо учасник не може взяти участь у події, він може будь-коли до початку події передати свою оплачену реєстрацію іншому гравцеві (заміннику). Передача безкоштовна.

Порядок передачі: достатньо написати на [info@panprstenu.cz](mailto:info@panprstenu.cz), що не можеш взяти участь, і вказати варіабельний символ (платіжний ідентифікатор) гравця, якому передаєш внесок. Організатор скасує початкову реєстрацію і перепише платіж на замінника.

Замінник повинен мати власну реєстрацію і відповідати всім умовам участі, зокрема віку, правилам реєстрації та, можливо, умовам участі неповнолітніх.

Можливий фінансовий розрахунок між початковим учасником і замінником відбувається виключно між ними — організатор у нього не втручається.

## 6. Скасування з боку учасника {#storno}

Учасник може будь-коли скасувати свою реєстрацію запитом, надісланим на e-mail організатора [info@panprstenu.cz](mailto:info@panprstenu.cz). **Вирішальною датою** для оцінки права на повернення оплати є дата доставлення запиту про скасування організаторові.

Сплачений реєстраційний внесок повертається за такими періодами:

- **до 30. 6. 2026** — повертаємо **100 %** сплаченої суми,
- **від 1. 7. до 31. 7. 2026** — повертаємо **50 %** сплаченої суми,
- **від 1. 8. 2026** (включно з часом проведення події та після її завершення) — реєстраційний внесок **не повертається**.

Ця шкала відображає той факт, що організатор розраховує на учасника при підготовці події, і з наближенням дати дедалі більша частина внесків уже сплачена або зобов'язально замовлена (оренда, туалети, вода, транспорт, матеріал та інші безповоротні витрати).

Інші правила розрахунку:

- Повернення надсилаємо банківським переказом на рахунок, з якого надійшла оплата (або на інший рахунок, який учасник письмово вкаже), не пізніше 30 днів від підтвердження скасування організатором.
- Для сімейної реєстрації повернення обчислюється як різниця загальної сімейної ціни до та після відписання даного члена.
- Неоплачену реєстрацію можна скасувати будь-коли без оплати.
- Добровільний донорський внесок має власний режим (див. реєстраційну форму), і ці періоди скасування на нього не поширюються.
- Платежі, отримані в євро, повертаємо з перерахунком за курсом на момент повернення; можливі банківські комісії та курсові різниці несе учасник.

Замість скасування реєстрацію можна будь-коли передати заміннику згідно зі статтею 5 — на передачу часові періоди не поширюються.

Періоди скасування стосуються лише скасування реєстрації з боку учасника. Порядок дій при зміні місця, зміні дати або скасуванні події регулюють статті 7–10.
...
- [Практична інформація](/uk/organizacni-informace/)
