...
chapters:
  - id: "co-je"
    label: "1. What Pán Prstenů is"
    icon: "lucide:tent"
  - id: "co-je-larp"
    label: "2. What LARP is"
    icon: "lucide:drama"
  - id: "vhodnost"
    label: "3. Is the event for me?"
    icon: "lucide:user-check"
  - id: "vek"
    label: "4. Age and participation"
    icon: "lucide:cake"
  - id: "vyber-frakce"
    label: "5. Pick a side and army"
    icon: "lucide:flag"
  - id: "kostym"
    label: "6. Costume and gear"
    icon: "lucide:shirt"
  - id: "pravidla"
    label: "7. Rules and safety"
    icon: "lucide:shield-check"
  - id: "registrace"
    label: "8. Registration and payment"
    icon: "lucide:credit-card"
  - id: "prijezd"
    label: "9. Arrival and first day"
    icon: "lucide:map-pin"
  - id: "vikend"
    label: "10. Weekend at play"
