...
const cs = {
  ...
  'program.day_1': '20. 8. čtvrtek',
  'program.day_1_desc': 'Příjezd, ubytování a registrace',
  'program.day_2': '21.–22. 8. pátek–sobota',
  'program.day_2_desc': 'Hlavní herní dny a bitvy',
  'program.day_3': '23. 8. neděle',
  'program.day_3_desc': 'Závěrečná bitva a odjezd',

  // CO TĚ ČEKÁ
  'whatsexpected.heading': 'Co tě čeká',
  'whatsexpected.item_1': 'Epické bitvy a strategické střety',
  'whatsexpected.item_2': 'Příběhové mise a rozhodnutí',
  'whatsexpected.item_3': 'Tábory, řemesla a atmosféra',
  'whatsexpected.item_4': 'Noční atmosféra a oheň',
  'whatsexpected.item_5': 'Přátelé a nezapomenutelné zážitky',

  // REGISTRAČNÍ BOX
  'reg_box.heading': 'Registrace',
  'reg_box.item_1': 'Registrace probíhá online přes Registracka.cz',
  ...
  'faq.a3': 'Registrace probíhá online přes Registracka.cz. Po vyplnění formuláře dostaneš potvrzení a pokyny k platbě. Platbu je nutné provést do 10 dnů.',
