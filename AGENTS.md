...
> **Tento soubor čte Codex automaticky při startu každého vlákna v tomto projektu.**
...
- Pracuje ve **VS Code** s GitHub Copilot, Codex, Codex.
...
- `grafika/` — všech 12 hi-fi mockupů (READ-ONLY pro Codex)
